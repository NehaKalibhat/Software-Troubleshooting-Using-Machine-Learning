...
with open("Grep/master_all_data.csv") as f:
	file_lines = []
	for i in f:
		file_lines.append(i)
	i = 0
...
plt.plot(inputs[-3], label = "misconfig 9")
plt.legend()
plt.show()
'''
...
model.add(LSTM(200, input_shape = (1, inputs_train.shape[2])))
model.add(Dense(10))
model.compile(loss='mean_squared_error', optimizer='adam', metrics=['accuracy'])
model.fit(inputs_train, outputs_train, epochs=300)
