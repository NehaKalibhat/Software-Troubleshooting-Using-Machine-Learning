...
loop = 200
write_dir = "/home/neha/Data Collector Cluster/Hetero/Dfsio/"
misconfig_node = "Master"
if not os.path.exists(write_dir+"1_0_0"):
    os.makedirs(write_dir+"1_0_0")
collect_data(loop, misconfig_node, "cd Neha_Shreya/HiBench/HiBench; source ./myenv; bin/workloads/micro/dfsioe/hadoop/run.sh",write_dir)
