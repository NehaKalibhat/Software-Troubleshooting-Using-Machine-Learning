...
loop = 200
write_dir = "/home/neha/Data Collector Cluster/Hetero/PageRank_Bench/"
misconfig_node = "Master"
if not os.path.exists(write_dir+"1_0_0"):
    os.makedirs(write_dir+"1_0_0")
collect_data(loop, misconfig_node, "cd Neha_Shreya/BigDataBench_V3.2.1_Hadoop_Hive/SearchEngine/PageRank; source ./myenv; ./run_PageRank.sh 10",write_dir)
