...
loop = 1
misconfig_code = 0
write_dir = "/home/neha/Data Collector Cluster/Scale/Dfsio/Normal/"
if not os.path.exists(write_dir):
    os.makedirs(write_dir)
while loop:
	print "LOOP ",loop
	run_script(misconfig_code, "cd Neha_Shreya/HiBench/HiBench; source ./myenv; bin/workloads/micro/dfsioe/hadoop/run.sh",write_dir)
	loop -= 1
